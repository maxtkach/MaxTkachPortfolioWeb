...
const competencies = [
  {
    ...
    description: "Development of adaptive landing pages and corporate websites",
    icon: (
          ...
          <motion.div variants={itemVariants}>
            ...
            <div className="space-y-4 sm:space-y-6 text-base sm:text-lg">
              <p className="text-white/90">
                I am a web developer from Ukraine with more than 3 years of experience in creating modern web solutions. 
                My mission is to transform your ideas into powerful digital products.
              </p>

              <div>
                <p className="text-white/90 mb-6">Key Competencies:</p>
                <motion.div 
              ...
              <p className="text-white/90">
                I work with businesses of various scales: from local companies to startups.
              </p>
              ...
              <div className="bg-gradient-to-r from-purple-500/20 to-pink-500/20 rounded-xl p-4 sm:p-6 backdrop-blur-sm border border-white/20">
                <p className="text-white font-medium">
                  Looking for a reliable technical partner for your project?
                  I am open to new collaboration opportunities on a project or permanent basis.
                </p>
              </div>
