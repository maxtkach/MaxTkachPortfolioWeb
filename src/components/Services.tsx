...
const services: Service[] = [
  ...
  {
    title: "Дизайн та верстка",
    price: "від 150$",
    description: "Реалізую сайт за вашим макетом (Figma) або створю з нуля стильний, чистий UI",
    features: [
      "Робота з Figma макетами",
      "Створення UI з нуля",
      "Tailwind CSS",
      "Використання AI інструментів",
      "Чистий та сучасний код"
    ]
  },
  {
    title: "Підтримка",
